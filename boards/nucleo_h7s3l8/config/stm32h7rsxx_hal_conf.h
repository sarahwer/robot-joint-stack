...
/* robot-joint-stack: taken from STM32CubeH7RS Projects/NUCLEO-H7S3L8/Templates/Template/Boot
 * (BSD-3-Clause, see THIRD_PARTY_NOTICES.md). Changes: FDCAN and UART modules enabled. */
